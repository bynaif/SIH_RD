...
def main():
    ...
    aptos_grade_metrics = print_multiclass_metrics(
        "E8 APTOS LOCKED TEST — 5-CLASS DR",
        aptos_true,
        aptos_prob,
    )

    aptos_ref_metrics = print_direct_referable_metrics(
        "E8 APTOS LOCKED TEST",
        aptos_true,
        aptos_ref_prob,
        threshold,
    )
    ...
    idrid_grade_metrics = print_multiclass_metrics(
        "E8 IDRiD OFFICIAL TEST — 5-CLASS DR",
        idrid_true,
        idrid_prob,
    )

    idrid_ref_metrics = print_direct_referable_metrics(
        "E8 IDRiD OFFICIAL TEST",
        idrid_true,
        idrid_ref_prob,
        threshold,
    )

...
def main():
    ...
    print("domain sampling: full training data" if DOMAIN_SAMPLES is None else f"domain sampling: {DOMAIN_SAMPLES}")
    ...
    if DOMAIN_SAMPLES is None:
        aptos_train = AptosE4Dataset(aptos_train_full)
    else:
    ...
    if DOMAIN_SAMPLES is None:
        idrid_train = IDRiDE4Dataset(idrid_train_base)
    else:
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        save_checkpoint(
            ...
            metrics,
            {
                ...
                "weight_decay": WEIGHT_DECAY,
                "domain_sampling": "full_training_data" if DOMAIN_SAMPLES is None else DOMAIN_SAMPLES,
